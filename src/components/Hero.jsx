          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
              <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-6xl">
                    ...
                    <span className="bg-gradient-to-r from-green-300 via-slate-500 to-blue-400 bg-clip-text text-4xl tracking-tight text-transparent">
                       {ABOUT_ME.title}
                    </span>
            ...
            <div className="w-full lg:w-1/2 lg:p-8">
                <div className="flex justify-center">
                    <img className="w-[55%]" src={iam} alt="Sergio Díaz" />
                </div>
        </div>
      </div>
    </div>
